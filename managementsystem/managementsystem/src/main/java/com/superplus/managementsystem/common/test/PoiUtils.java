...
public class PoiUtils{
    ...
    public static List<Orderform> importOrdersList(MultipartFile file){
                    ...
                    for (int k = 0; k < physicalNumberOfCells; k++) {
                        ...
                        switch (cell.getCellTypeEnum()) {
                            case STRING: {
                                ...
                                switch (k) {
                                    case 0:
                                        orderform.setItemname(cellValue);
                                        break;
                                    case 1:
                                        orderform.setSku(cellValue);
                                        break;
                                    case 2:
                                        orderform.setSize(cellValue);
                                        break;
                                    case 4:
                                        orderform.setPrice(cellValue);
                                        break;
                                    case 5:
                                        orderform.setTotal(cellValue);
                                        break;
                                    case 8:
                                        orderform.setPurchaseorder(cellValue);
                                        break;
                                    case 9:
                                        orderform.setTlogistics(cellValue);
                                        break;
                                    case 10:
                                        orderform.setSlogistics(cellValue);
                                        break;
                                    case 11:
                                        orderform.setBoxcode(cellValue);
                                        break;
                                    case 12:
                                        orderform.setComment(cellValue);
                                        break;
                                }
                            }
                            break;
                            default: {
                                switch (k) {
                                    case 3:
                                        orderform.setPoqty(cell.getNumericCellValue());
                                        break;
                                    case 6:
                                        orderform.setPurchaseprice(cell.getNumericCellValue());
                                        break;
                                    case 7:
                                        orderform.setRpp(cell.getNumericCellValue());
                                        break;
                                }
                            }
                            break;
